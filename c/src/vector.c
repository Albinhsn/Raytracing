...
inline void scaleVec3f32(Vec3f32* res, Vec3f32* v, f32 t)
{
  res->x = v->x * t;
  res->y = v->y * t;
  res->z = v->z * t;
}
inline void addVec3f32(Vec3f32* res, Vec3f32* v0, Vec3f32* v1)
{
  res->x = v0->x + v1->x;
  res->y = v0->y + v1->y;
  res->z = v0->z + v1->z;
}
inline void subVec3f32(Vec3f32* res, Vec3f32* v0, Vec3f32* v1)
{
  res->x = v0->x - v1->x;
  res->y = v0->y - v1->y;
  res->z = v0->z - v1->z;
}
inline void mulVec3f32(Vec3f32* res, Vec3f32* v0, Vec3f32* v1)
{
  res->x = v0->x * v1->x;
  res->y = v0->y * v1->y;
  res->z = v0->z * v1->z;
...
inline f32 lengthVec3f32(Vec3f32* v)
{
